...
import fr.timothefcn.mc.loupgarou.events.LGVoteLeaderChange;
...
public class LGVote {
    ...
    private void end() {
        ...
        if (equal && mayor != null && max != 0) {
            ...
            mayor.choose(new LGPlayer.LGChooseCallback() {
    ...
    public LGPlayer.LGChooseCallback getChooseCallback(LGPlayer who) {
        return new LGPlayer.LGChooseCallback() {
