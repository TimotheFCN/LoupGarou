...
import fr.timothefcn.mc.loupgarou.events.LGGameEndEvent;
import fr.timothefcn.mc.loupgarou.events.LGNightPlayerPreKilledEvent;
import fr.timothefcn.mc.loupgarou.events.LGPlayerKilledEvent;
import fr.timothefcn.mc.loupgarou.events.LGPreDayStartEvent;
import fr.timothefcn.mc.loupgarou.utils.VariableCache;
...
public class RSurvivant extends Role {
    ...
    public void onPlayerKill(LGNightPlayerPreKilledEvent e) {
        if (e.getGame() == getGame() && (e.getReason() == LGPlayerKilledEvent.Reason.LOUP_GAROU || e.getReason() == LGPlayerKilledEvent.Reason.LOUP_BLANC || e.getReason() == LGPlayerKilledEvent.Reason.GM_LOUP_GAROU || e.getReason() == LGPlayerKilledEvent.Reason.ASSASSIN) && e.getKilled().getCache().getBoolean("survivant_protected")) {
            e.setReason(LGPlayerKilledEvent.Reason.DONT_DIE);
        }
    }
