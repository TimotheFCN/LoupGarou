...
public class RAssassin extends Role {
        ...
        player.choose(new LGPlayer.LGChooseCallback() {
            ...
            public void callback(LGPlayer choosen) {
                if (choosen != null && choosen != player) {
                    getGame().kill(choosen, LGPlayerKilledEvent.Reason.ASSASSIN);
    ...
    public void onKill(LGNightPlayerPreKilledEvent e) {
        if (e.getKilled().getRole() == this && e.getReason() == LGPlayerKilledEvent.Reason.LOUP_GAROU || e.getReason() == LGPlayerKilledEvent.Reason.GM_LOUP_GAROU) {//Les assassins ne peuvent pas mourir la nuit !
