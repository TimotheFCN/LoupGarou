...
import fr.timothefcn.mc.com.comphenix.packetwrapper.WrapperPlayServerHeldItemSlot;
...
import fr.timothefcn.mc.loupgarou.events.LGDayEndEvent;
import fr.timothefcn.mc.loupgarou.events.LGMayorVoteEvent;
import fr.timothefcn.mc.loupgarou.events.LGPlayerKilledEvent;
import fr.timothefcn.mc.loupgarou.events.LGVoteEvent;
...
public class RDictateur extends Role {
    ...
    protected void kill(LGPlayer choosen, LGPlayer dicta, Runnable callback) {
        ...
        LGPlayerKilledEvent killEvent = new LGPlayerKilledEvent(getGame(), choosen, LGPlayerKilledEvent.Reason.DICTATOR);
        ...
        if (roleType != RoleType.VILLAGER) {
            ...
            getGame().kill(dicta, LGPlayerKilledEvent.Reason.DICTATOR_SUICIDE);
    ...
    public void onNight(LGDayEndEvent e) {
        if (e.getGame() == getGame()) {
            LGPlayer lgp = getGame().getDeaths().get(LGPlayerKilledEvent.Reason.DICTATOR_SUICIDE);
            if (lgp != null)
