...
public class RSorciere extends Role {
    ...
    protected void onNightTurn(LGPlayer player, Runnable callback) {
        ...
        sauver = getGame().getDeaths().get(LGPlayerKilledEvent.Reason.LOUP_GAROU);
        if (sauver == null)
            sauver = getGame().getDeaths().get(LGPlayerKilledEvent.Reason.DONT_DIE);
    ...
    private void kill(LGPlayer choosen, LGPlayer player) {
        ...
        getGame().kill(choosen, LGPlayerKilledEvent.Reason.SORCIERE);
    ...
    private void saveLife(LGPlayer player) {
        ...
        getGame().getDeaths().remove(LGPlayerKilledEvent.Reason.LOUP_GAROU, sauver);
