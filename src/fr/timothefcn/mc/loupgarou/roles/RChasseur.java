...
import fr.timothefcn.mc.loupgarou.events.LGDayStartEvent;
import fr.timothefcn.mc.loupgarou.events.LGGameEndEvent;
import fr.timothefcn.mc.loupgarou.events.LGNightStart;
...
public class RChasseur extends Role {
    ...
    protected void onNightTurn(LGPlayer player, Runnable callback) {
        ...
        player.choose((choosen) -> {
            if (choosen != null) {
                player.stopChoosing();
                getGame().cancelWait();
                LGPlayerKilledEvent killEvent = new LGPlayerKilledEvent(getGame(), choosen, LGPlayerKilledEvent.Reason.CHASSEUR);
    ...
    public void onPlayerKill(LGPlayerKilledEvent e) {
        if (e.getKilled().getRole() == this && e.getReason() != LGPlayerKilledEvent.Reason.DISCONNECTED)
